...
void main(){
    ...
    Uint8List decryptedNonceCalc = aesCipherNonce.decrypt(
        data: nonceEncypted, key: kpi, iv: Uint8List(AES_BLOCK_SIZE));
    ...
    Uint8List encryptedTByAES = aesCipher.encrypt(data:calcInputDataTTerminal, key: macKey, iv: Uint8List(AES_BLOCK_SIZE), padding: true);
    ...
    Uint8List encryptedCByAES = aesCipher.encrypt(data:calcInputDataTChip, key: macKey, iv: Uint8List(AES_BLOCK_SIZE), padding: true);
